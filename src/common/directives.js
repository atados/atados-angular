...
app.directive('projectCard', function() {
  return {
    restrict: 'E',
    transclude: true,
    templateUrl: '/views/partials/projectCard.html'
  };
});
...
app.directive('depoimento', function() {
  return {
    restrict: 'E',
    transclude: true,
    templateUrl: '/views/partials/depoimento.html'
  };
});
...
app.directive('nonprofitCard', function() {
  return {
    restrict: 'E',
    transclude: true,
    templateUrl: '/views/partials/nonprofitCard.html'
  };
});
...
app.directive('emailSignupInput', function (Auth) {
  return {
    ...
    templateUrl: '/views/partials/emailSignupInput.html',
    link: function(scope) {
...
app.directive('phoneInput', function () {
  return {
    ...
    templateUrl: '/views/partials/phoneInput.html',
    link: function() {
      $('#phoneInput').focus(
        function(){
...
app.directive('zipcodeInput', function () {
  return {
    ...
    templateUrl: '/views/partials/zipcodeInput.html',
    link: function() {
...
app.directive('causes', function () {
  return {
    ...
    templateUrl: '/views/partials/causeInput.html',
    link: function(scope) {
      if (!scope.selected) {
        scope.selected = [];
      }
...
app.directive('skills', function () {
  return {
    ...
    templateUrl: '/views/partials/skillInput.html',
    link: function(scope) {
      if (!scope.selected) {
        scope.selected = [];
      }
