...
var config = {
  ...
  // ----------------------------------
  app_entry : 'index.js',
  api_url   : 'http://www.atadoslocal.com.br:8000/v1',
  google_maps_api_key: 'AIzaSyA6FtG9g5KebYrjsnA8iBtX4NDty3Rofp0',
...
config.api = path.resolve.bind(path.resolve, config.api_url)
